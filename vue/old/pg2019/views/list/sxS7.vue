            ...
            <div class="row" style="margin-top:30px;">
              ...
              <div class="col-10">
                ...
                <div style="text-align:center;border-top:1.5px solid #666;clear:both;margin-right:2%;text-indent: 30px;padding-top:70px;">
					...
					<h1 class="detail-title">天健，你值得拥有</h1>
					<div class="detail-attributes">
						<p class="detail-date">[安徽财经大学    王倓    税务实习生    实习地点：杭州总部]　　发布日期：2015-06-04</p>
...
<div class="jiathis_style">
	...
	<a class="jiathis_counter_style"></a>
					...
					<div class="detail-content">
						<!-- 正文内容全部动态替换，开始。 -->
						<p>　　从杭州钱塘江畔到湖南的浏阳河边，从宁波东海之滨到北京大运河旁，我了解到审计工作旅途辛苦却充满乐趣；从凭证测试、年末盘点资产到书写底稿、摘附注，我认识到初出茅庐的我要学习的还有很多。在天健实习两个月收获了很多，拿到OFFER是前进的动力。我相信，天健，你值得拥有！</p>

<p style="text-align:center"><img alt="" src="http://www.pccpa.cn/uploadFiles/images/%E5%AE%9E%E4%B9%A0%E7%94%9F%E9%A3%8E%E9%87%87/1_%E7%8E%8B%E5%80%93.jpg"></p>
