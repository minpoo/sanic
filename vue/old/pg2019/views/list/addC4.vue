              ...
              <div class="col-2">
                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                   ...
                   <li class="nav-item">
                   <router-link style="background:#7ebeef;color:#fff;" id="one" class="nav-link disabled" @mouseenter="changeColor" @mouseleave="changeColorOut" to="/list/addC4">{{list[4]}}</router-link>
                  </li>
                </ul>
              ...
              <div class="col-10">
                ...
                <div style="text-align:center;border-top:1.5px solid #666;clear:both;margin-right:2%;text-indent: 30px;padding-top:70px;">
                  <div id="iframe" style="text-align: center">
                      <iframe src="http://hr.pccpa.cn/job/RegUser.aspx?empstyle=1" id="iframepage" name="iframepage" frameborder="0" scrolling="no" width="100%" style="height: 595px;"></iframe>
                  </div>
                </div>
              </div>
            </div>  
