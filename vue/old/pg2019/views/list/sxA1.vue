            ...
            <div class="row" style="margin-top:30px;">
              ...
              <div class="col-10">
                ...
                <div style="text-align:center;border-top:1.5px solid #666;clear:both;margin-right:2%;text-indent: 30px;padding-top:70px;">
					...
					<h1 class="detail-title">暑期实习生简介</h1>
					<div class="detail-attributes">
						<p class="detail-date">[人力资源总部]　　发布日期：2015-06-04</p>
...
<div class="jiathis_style">
	...
	<a class="jiathis_counter_style"></a>
					...
					<div class="detail-content">
						<!-- 正文内容全部动态替换，开始。 -->
						<p><img alt="" src="http://www.pccpa.cn/uploadFiles/images/zhaopin/%E5%A4%A9%E5%81%A5%E6%9A%91%E6%9C%9F%E5%AE%9E%E4%B9%A0%E7%AE%80%E4%BB%8B.jpg"></p>
