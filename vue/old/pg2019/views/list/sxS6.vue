            ...
            <div class="row" style="margin-top:30px;">
              ...
              <div class="col-10">
               ...
               <div class="page-detail">
					<h1 class="detail-title">愿为天健一分子</h1>
					<div class="detail-attributes">
						<p class="detail-date">[重庆工商大学  王贵林   审计实习生  实习地点：重庆分所]　　发布日期：2015-06-05</p>
...
<div class="jiathis_style">
	...
	<a class="jiathis_counter_style"></a>
					...
					<div class="detail-content">
						<!-- 正文内容全部动态替换，开始。 -->
						<p style="text-align:center">缘定天健来实习，踏实认真做审计。</p>

<p style="text-align:center">专业工作实不易，时刻准备砺斗志。</p>

<p style="text-align:center">审计过程须严谨，一丝不苟按程序。</p>

<p style="text-align:center">全程依法要自律，保证不能出问题。</p>

<p style="text-align:center">底稿要求也是细，数据证据留痕迹。</p>

<p style="text-align:center">全组员工人心齐，同一目标共努力。</p>

<p style="text-align:center">确保任务按时毕，团结拼搏争朝夕。</p>

<p style="text-align:center">感谢组织重培育，愿为天健一分子。</p>

<p style="text-align:center"><img alt="" src="http://www.pccpa.cn/uploadFiles/images/%E5%AE%9E%E4%B9%A0%E7%94%9F%E9%A3%8E%E9%87%87/7_%E7%8E%8B%E8%B4%B5%E6%9E%97.jpg"></p>
...
<p style="text-align:center">&nbsp;</p>
					...
					<!-- 
					< %
					News n1=dbq.getPrevNewsByID( request.getParameter("chid"),Integer.parseInt( request.getParameter("id")));
					News n2=dbq.getNextNewsByID(request.getParameter("chid"),Integer.parseInt( request.getParameter("id")));
					% >
					<div class="detail-forward">
						< %
							if (null==n2){
								out.println("<a class='next' href='#'>下一篇:没有了</a>");
							}else{
								out.println("<a class='next' href='detail.jsp?chid="+request.getParameter("chid") +"&id="+n2.idNews+"'>下一篇:"+n2.title+"</a>");
							}
							if (null==n1){
								out.println("<a class='prev' href='#'>上一篇:没有了</a>");
							}else{
								out.println("<a class='prev' href='detail.jsp?chid="+request.getParameter("chid") +"&id="+n1.idNews+"'>上一篇:"+n1.title+"</a>");
							}
						% >
					</div>
					 -->
