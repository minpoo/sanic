                ...
                <div style="text-align:left;border-top:1.5px solid #666;clear:both;margin-right:2%;text-indent: 30px;padding-top:70px;">
                    <div class="page-detail">
                                  <div class="detail-text">
                                    <h3 class="area-text-title" style="background-color: #73a5c3;">保险公估服务</h3>

                                    <p>天健拥有65名保险公估业务人员，业务人员中具有高级会计师、高级工程师等高级职称和硕士以上学位近20人，还拥有一个门类齐全的专家咨询网络。具体业务范围主要为：</p>
                                    <p>&nbsp;</p>
                                    <p>1. 保险标的承保前的检验、估价及风险评估；</p>
                                    <p>&nbsp;</p>
                                    <p>2. 保险标的出险后的查勘、检验、估损及理算。</p>
                                  </div>
                        ...
                        <div class="area-contact">
                          <dl>
                            <dt>欢迎垂询</dt>
                            <dd class="telphone1"><i></i><span>0571-88216944</span></dd>
                            <dd class="telphone2"><i></i><span>0571-88216968</span></dd>
                            <dd class="email"><i></i><span><a href="email:pwf@pccpa.cn">pwf@pccpa.cn</a></span></dd>
                            <dd class="address"><i></i><span>杭州市西溪路128号新湖商务大厦</span></dd>
                          </dl>
                        </div><!-- .area-contact END -->
                                </div>
                </div>
                

                <div style="text-align:left">
                  <img src="../../assets/img/easy4.png">
                </div>
