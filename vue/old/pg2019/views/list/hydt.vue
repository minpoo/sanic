<template>
    <div>
       <top/>
         <div >
            <div><img src="../../assets/img//banner-news.jpg"></div>
            <div class="row" style="margin-top:30px;">
              <div class="col-2">
                <div style="font-weight:bold;color:#fff;font-size:30px;background:#3a8bc8;border-top:5px solid #4ca7d3;padding:10px;">新闻中心</div>
                <ul class="nav flex-column">
                  <li class="nav-item">
                    <a class="nav-link disabled" @mouseenter="changeColor" @mouseleave="changeColorOut"  href="#/news">天健资讯</a>
                  </li>
                  <li class="nav-item">
                    <router-link id="one" @mouseenter="changeColor($event)"  @mouseleave="changeColorOut"  style="background:#7ebeef;color:#fff;" class="nav-link disabled"  to="/list/hydt">行业动态</router-link>
                  </li>
                  <li class="nav-item">
              ...
              <div class="col-10">
                <div>
                    ...
                    <div style="float:right;font-size:11px;padding-right:2%;line-height:41.25px;margin-bottom:10px;">
                      <router-link to="/">首页</router-link>-<router-link to="/">新闻中心</router-link>-<router-link to="/">行业动态</router-link>
                    </div>
                </div>
                <div style="border-top:1.5px solid #666;clear:both;margin-right:2%">
                  <div style="padding:20px;"> 
                     <img src="../../assets/img/行业动态-杭州湾跨海大桥.jpg" alt="" srcset="">
                  </div>
                    ...
                    <div class="row" style="padding:20px;text-align:left;border-bottom:1px dashed #707070">
                      ...
                      <div class="col-10">
                        <div style="font-size:20px;font-weight:bold;color:#707070;">
                           <router-link to="/">{{i.article.title}}</router-link> 
