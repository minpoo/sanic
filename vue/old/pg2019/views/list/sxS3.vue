            ...
            <div class="row" style="margin-top:30px;">
              ...
              <div class="col-10">
                ...
                <div style="text-align:center;border-top:1.5px solid #666;clear:both;margin-right:2%;text-indent: 30px;padding-top:70px;">
					...
					<h1 class="detail-title">前进路上、感谢有你</h1>
					<div class="detail-attributes">
						<p class="detail-date">[华中农业大学  孙斌  审计实习生   实习地点：杭州总部]　　发布日期：2015-06-05</p>
...
<div class="jiathis_style">
	...
	<a class="jiathis_counter_style"></a>
					...
					<div class="detail-content">
						<!-- 正文内容全部动态替换，开始。 -->
						<p>　　寥寥数语说不尽心中感慨，离开时想起的是埋头底稿中auditor们疲惫却充满激情的笑脸。一个多月的实习，感谢卢老师对我耐心指导和严苛要求、学到了凡事要寻根究底；感谢前辈们的殷切关心和激励鼓舞，砥砺我在疲倦时重振信心；感谢能够在七总二部学到详实具象的审计知识，前进路上、感谢有你，天健！</p>

<p style="text-align:center"><img alt="" src="http://www.pccpa.cn/uploadFiles/images/%E5%AE%9E%E4%B9%A0%E7%94%9F%E9%A3%8E%E9%87%87/4_%E5%AD%99%E6%96%8C.jpg"></p>
