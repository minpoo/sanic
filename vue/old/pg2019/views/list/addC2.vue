            ...
            <div class="row" style="margin-top:30px;">
              <div class="col-2">
                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                   <router-link style="background:#7ebeef;color:#fff;" id="one"  class="nav-link disabled" @mouseenter="changeColor" @mouseleave="changeColorOut" to="/list/addC2">{{list[2]}}</router-link>
                  </li>
                   <li class="nav-item">
              ...
              <div class="col-10">
                ...
                <div style="text-align:center;border-top:1.5px solid #666;clear:both;margin-right:2%;text-indent: 30px;padding-top:70px;">
                    <div id="iframe" style="text-align: center">
                      <iframe src="http://hr.pccpa.cn/job/joblist.aspx?empstyle=3" id="iframepage" name="iframepage" frameborder="0" scrolling="no" width="100%" style="height: 1017px;"></iframe>
                    </div>
                </div>
              </div>
            </div>  
