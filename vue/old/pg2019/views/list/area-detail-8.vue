              ...
              <div class="col-10">
                ...
                <div style="text-align:left;border-top:1.5px solid #666;clear:both;margin-right:2%;text-indent: 30px;padding-top:70px;">
					...
					<div class="detail-text">
						<h3 class="area-text-title" style="background-color: #67a38b;">司法会计鉴定服务</h3>

						<p>天健承办的一系列票据专案审计、经济贪污案件鉴定、资产评估司法鉴定、工程造价鉴定等司法鉴定业务项目，受到有关部门的好评，在同行中拥有良好声誉。具体业务范围主要为：</p>
						<p>&nbsp;</p>
						<p>1. 司法会计鉴定；</p>
						<p>&nbsp;</p>
						<p>2. 资产评估司法鉴定；</p>
